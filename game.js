...
5:{
 ...
 sequence:[
  {id:'wake-up',text:'Wake up.'},
  {id:'get-up',text:'Get up.'},
  {id:'get-dressed',text:'Get dressed.'},
  {id:'brush-teeth',text:'Brush your teeth.'},
  {id:'wash-face',text:'Wash your face.'},
  {id:'breakfast',text:'Have sandwiches for breakfast.'},
  {id:'swim',text:'Swim in the lake.'},
  {id:'make-fire',text:'Make a fire.'},
  {id:'cook',text:'Cook.'},
  {id:'lunch',text:'Have lunch.'},
  {id:'read-book',text:'Read a book.'},
  {id:'play-ball',text:'Play with a ball.'},
  {id:'dinner',text:'Have dinner.'},
  {id:'board-game',text:'Play a board game.'},
  {id:'go-bed',text:'Go to bed.'}
 ],
 slots:[
...
function mission5CardsHtml(){
 ...
 return ids.map((id,i)=>{
   ...
   return `<button class="source mission5-card" data-source="${id}" aria-label="${src[1]}" title="${src[1]}" style="${pct(cfg.slots[i])}"><img class="mission5-card-img" src="${sourceImg(5,id)}" alt=""><span class="mini-check">${icons.check()}</span></button>`;
 }).join('');
}
...
function renderMission(m){
 ...
 if(m===5){overlay+=`<div class="mission5-board"></div>`+mission5CardsHtml()+`<div class="mission5-panel"><div class="mission5-title">Listen and choose the picture.</div><div class="mission5-prompt" id="m5-prompt"></div><button class="mission5-listen" data-control="say5">${icons.speech()} Listen again</button><div class="mission5-progress" id="m5-progress"></div></div>`;}
